...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (Schema::hasTable('users') && !Schema::hasColumn('users', 'is_currently_online')) {
        ...
        if (Schema::hasTable('chats') && !Schema::hasColumn('chats', 'message_count')) {
        ...
        if (DB::getDriverName() === 'mysql' && Schema::hasTable('users') && Schema::hasTable('chats') && Schema::hasTable('messages') && Schema::hasTable('user_activities')) {
            DB::statement('
            ...
            ');
        } elseif (DB::getDriverName() === 'pgsql' && Schema::hasTable('users') && Schema::hasTable('chats') && Schema::hasTable('messages') && Schema::hasTable('user_activities')) {
            DB::statement('
                CREATE VIEW active_user_stats AS
                SELECT 
                    u.id,
    ...
    public function down(): void
    {
        ...
        if (Schema::hasTable('users')) {
            Schema::table('users', function (Blueprint $table) {
                if (Schema::hasColumn('users', 'is_currently_online')) {
        ...
        if (Schema::hasTable('chats')) {
            Schema::table('chats', function (Blueprint $table) {
                if (Schema::hasColumn('chats', 'message_count')) {

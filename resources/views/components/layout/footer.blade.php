<footer class="bg-gradient-to-br from-gray-900 via-slate-900 to-gray-900 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 text-white relative overflow-hidden">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="lg:col-span-1">
                ...
                <div class="flex space-x-3">
                    <a href="#" class="group relative w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-700 rounded-xl flex items-center justify-center shadow-lg hover:shadow-blue-500/30 transition-all duration-300 transform hover:scale-110 hover:-translate-y-1">
                    ...
                    <a href="#" class="group relative w-12 h-12 bg-gradient-to-br from-sky-500 to-sky-700 rounded-xl flex items-center justify-center shadow-lg hover:shadow-sky-500/30 transition-all duration-300 transform hover:scale-110 hover:-translate-y-1">
                        <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M22.46 6c-.77.35-1.6.58-2.46.69.88-.53 1.56-1.37 1.88-2.38-.83.5-1.75.85-2.72 1.05C18.37 4.5 17.26 4 16 4c-2.35 0-4.27 1.92-4.27 4.29 0 .34.04.67.11.98C8.28 9.09 5.11 7.38 3 4.79c-.37.63-.58 1.37-.58 2.15 0 1.49.75 2.81 1.91 3.56-.71 0-1.37-.2-1.95-.5v.03c0 2.08 1.48 3.82 3.44 4.21a4.22 4.22 0 0 1-1.93.07 4.28 4.28 0 0 0 4 2.98 8.521 8.521 0 0 1-5.33 1.84c-.34 0-.68-.02-1.02-.06C3.44 20.29 5.7 21 8.12 21 16 21 20.33 14.46 20.33 8.79c0-.19 0-.37-.01-.56.84-.6 1.56-1.36 2.14-2.23z"/>
                        </svg>
                        <div class="absolute inset-0 rounded-xl bg-white/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    </a>
                    <a href="#" class="group relative w-12 h-12 bg-gradient-to-br from-pink-500 to-pink-700 rounded-xl flex items-center justify-center shadow-lg hover:shadow-pink-500/30 transition-all duration-300 transform hover:scale-110 hover:-translate-y-1">
                        <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="#" class="group relative w-12 h-12 bg-gradient-to-br from-purple-500 to-purple-700 rounded-xl flex items-center justify-center shadow-lg hover:shadow-purple-500/30 transition-all duration-300 transform hover:scale-110 hover:-translate-y-1">
                        <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Download -->
            <div>
                <h4 class="font-semibold text-lg mb-6 text-white">Download App</h4>
                <p class="text-gray-400 mb-8">Get YorYor on your mobile device</p>
                <div class="space-y-4">
                    <a href="#" class="group flex items-center space-x-4 bg-gradient-to-r from-gray-800 to-gray-700 hover:from-gray-700 hover:to-gray-600 p-4 rounded-2xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-gray-500/20">
                        <div class="relative w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-700 rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-blue-500/30 transition-shadow duration-300">
                        ...
                        <div>
                            ...
                            <div class="text-lg font-semibold text-white group-hover:text-blue-300 transition-colors duration-300">App Store</div>
                        </div>
                    </a>
                    <a href="#" class="group flex items-center space-x-4 bg-gradient-to-r from-gray-800 to-gray-700 hover:from-gray-700 hover:to-gray-600 p-4 rounded-2xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-gray-500/20">
                        <div class="relative w-12 h-12 bg-gradient-to-br from-green-500 to-green-700 rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-green-500/30 transition-shadow duration-300">
                            <svg class="w-7 h-7 text-white" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <div>
                            ...
                            <div class="text-lg font-semibold text-white group-hover:text-green-300 transition-colors duration-300">Google Play</div>
                        </div>
                    </a>
                </div>
            </div>
        ...
        <div class="border-t border-gray-800 mt-12 pt-8">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <p class="text-gray-400 text-sm">
                    © {{ date('Y') }} YorYor. All rights reserved.
                </p>

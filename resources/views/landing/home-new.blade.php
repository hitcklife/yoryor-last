<x-layouts.landing title="YorYor Global - Platform for Uzbeks Worldwide to Find Marriage Partners" description="Connect with Uzbeks worldwide for marriage. Trusted by 50,000+ families across 45 countries. Find your life partner within our global Uzbek community while preserving our values and traditions.">
    ...
    <!-- HIDDEN PRICING SECTION - COMMENTED OUT FOR NOW -->
    {{-- 
    <!-- International Pricing Section -->
    <section class="py-24 bg-gradient-to-br from-slate-50 via-white to-gray-50 relative overflow-hidden">
        <!-- Pricing content hidden for now since starting with free for all -->
    </section>
    --}}

...
const REVERB_APP_KEY = 'yoryor-key-123456';  // Use your Reverb app key
const REVERB_HOST = __DEV__ ? 'localhost' : 'api.yoryor.com';
const REVERB_PORT = 8080;
const REVERB_SCHEME = __DEV__ ? 'http' : 'https';
